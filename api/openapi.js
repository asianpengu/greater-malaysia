...
export default function handler(req, res) {
  ...
  res.status(200).json({
    ...
    paths: {
      ...
      "/api/holidays": { get: { operationId: "getPublicHolidays", summary: "Malaysian public holidays for a year, plus the next upcoming one. Optionally state-aware.", parameters: [p("year", "Four-digit year.", "2026"), p("state", "Optional state / federal territory code for the national + state union: jhr, kdh, ktn, mlk, nsn, phg, prk, pls, png, sbh, swk, sgr, trg, kul, lbn, pjy. Unknown codes return HTTP 400 with error code INVALID_STATE.", "png")], responses: { "200": ok("Public holidays"), "400": err, "502": err } } },
